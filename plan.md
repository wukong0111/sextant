...
| Fase 2 — v0.2 | 🔄 En progreso | `432d8df` (2.1 MySQL), `2778f89` (2.1 Docker tests + tipos), `ce9aa8d` (2.1 PG 18.4 / MySQL 9.7), `e576d47` (2.1 fix PG imagen), `4f8cd49` (2.1 conexiones Docker TUI) |
| Fase 3 — v1 | ⬜ Pendiente | — |
